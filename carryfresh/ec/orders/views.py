...
razorpay_client =razorpay.Client(auth=("rzp_test_sgExUCA7LlCxkT", "7D5xanlhQxmJ4ufPf7h08D1j"))
def place_order(request, total=0, quantity=0):
    ...
    return HttpResponse("This is a GET request, and you should handle it accordingly.")
...
def payments(request):
    if request.method == "POST":
        ...
        message = render_to_string('app/order_recive_email.html', {
            'user': request.user,
            'order': order,
        })
...
# Define the Razorpay payment success view
